...
class TaskControllerTest extends WebTestCase
{
    ...
    public function testDeleteTask()
    {
        ...
        $form = $crawler->filter('form')->selectButton('Supprimer')->eq(4)->form();
        $crawler = $this->client->submit($form);
    ...
    public function testDeleteTaskByAnotherUser()
    {
        ...
        $form = $crawler->filter('form')->selectButton('Supprimer')->eq(2)->form();
        $crawler = $this->client->submit($form);

        $this->assertResponseStatusCodeSame(403);
    }

    public function testDeleteTaskOfAnonymousUserWithSimpleUserLogin()
    {
        $this->userLogin();
    ...
    public function testDeleteTaskOfAnonymousUserWithAdminLogin()
    {
        $this->adminLogin();
